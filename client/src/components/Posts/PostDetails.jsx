...
const PostDetails = () => {
  ...
  return (
    <>
      {
        loading ? <LoadingSpinner /> : appErr || serverErr ? <h1>{appErr} {serverErr}</h1> : (<section className="py-20 2xl:py-40 bg-gray-800 overflow-hidden">
        <div className="container px-4 mx-auto">
          {/* Post Image */}
          <img
            className="mb-24 w-full h-96 object-contain"
        ...
        {/* Add comment Form component here */}
          {
            userAuth?._id && <AddComments postId={id}/>
          }
